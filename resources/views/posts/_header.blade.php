    ...
    <div class="mt-4 space-y-2 lg:space-y-0 lg:space-x-4">
        ...
        <div class="relative flex items-center px-3 py-2 bg-gray-100 lg:inline-flex rounded-xl">
            <form method="GET" action="/">
                ...
                <input type="text" name="search" placeholder="Find by title or excerpt"
        ...
        <div class="relative flex items-center px-3 py-2 bg-gray-100 lg:inline-flex rounded-xl">
            <form method="GET" action="/">
                ...
                <input type="text" name="author" placeholder="Find by author name"
                    class="text-sm font-semibold placeholder-black bg-transparent" value="{{ request('author') }}">
            </form>
        </div>
    </div>
</header>
